        ...
        {teams.map(({ name, occupation, image, items }, index) => (
          <div key={`item-team-${index}`} className="p-2">
            <ItemTeam
              ...
              nameClass="mb-1.5 text-base font-bold text-[var(--brand-primary-600)] dark:text-white"
              occupationClass="mb-7 text-sm font-medium capitalize text-gray-600 dark:text-slate-400"
