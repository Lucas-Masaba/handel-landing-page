...
const Features4 = ({
  ...
  >
    {header && <Headline header={header} titleClass="text-4xl md:text-5xl m-20" />}
    {isImageDisplayed && (
      <div aria-hidden="true" className="aspect-w-16 aspect-h-7">
        {image && (
          <Image
            className="w-full h-80 object-cover rounded-xl mx-auto bg-[var(--brand-primary-400)] shadow-lg"
            src={image.src}
            alt={image.alt}
            width={728}
            height={320}
