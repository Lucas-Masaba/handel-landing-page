  ...
  <div className="card mb-6 px-5 py-4">
    <div className="flex items-center justify-between">
      <div className="w-full">
        <h3 className="mb-3 text-base font-bold text-gray-700 dark:text-white">{title}</h3>
        <p className="text-gray-600 dark:text-slate-400 text-justify">{description}</p>
      </div>
      {href && (
    ...
    {form && (
      <div className="mt-2">
        <form className="rounded-md border border-[var(--brand-primary-50)] bg-white shadow-md">
          <div className="flex items-center">
            {form.icon && (
              <span className="rounded-bl-md rtl:rounded-bl-none rtl:rounded-br-md rounded-tl-md rtl:rounded-tl-none rtl:rounded-tr-md border-r-[1px] rtl:border-r-none rtl:border-l-[1px] border-[var(--brand-primary-50)] px-2 py-2 dark:bg-[var(--brand-primary-700)]">
    ...
    <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8 lg:pt-20">
      <div className="row-gap-10 grid gap-6 md:grid-cols-2">
        <div className="mx-auto md:my-auto md:ml-0 md:pb-6 md:pr-24">
          ...
          <p className="text-center text-base text-gray-200 dark:text-slate-300 md:text-left rtl:md:text-right text-justify">
            {subtitle}
          </p>
        </div>
